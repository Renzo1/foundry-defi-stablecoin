...
contract Handler is Test {
    ...
    function depositCollateral(
        ...
        usersWithCollateralDeposited.push(msg.sender); //This will double push if thesame address is pushed twice
    }
    ...
    function redeemCollateral(
        ...
        ERC20Mock collateral = _getCollateralFromSeed(collateralSeed);
        uint256 maxCollateralToRedeem = dsce.getColletralBalanceOfUser(
            address(collateral),
            msg.sender
        );
    ...
    // This breaks our invariant test suite. When price crashes too quickly.
